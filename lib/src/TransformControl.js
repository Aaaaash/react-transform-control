...
var TransformControl = (function (_super) {
    ...
    function TransformControl() {
        ...
        _this.createControlSelection = function () {
            ...
            return !disabled ? (<div className="transform_drag_element">
        {HANDLER.map(function (v) { return (<div className={"transform_drag_handle drag_" + v} key={"drag" + v} onMouseDown={_this.onScaleMouseTouchDown} onTouchStart={_this.onScaleMouseTouchDown}/>); })}
        {HANDLER.map(function (v) { return (<div className={"transform_rotate_handle " + v} key={"rotate" + v}/>); })}
      </div>) : null;
        };
    ...
    TransformControl.prototype.render = function () {
        ...
        return (<div className="transform_container" style={__assign({}, styles)} ref={function (ele) { return (_this.componentElement = ele); }} onTouchStart={this.onComponentMouseTouchDown} onMouseDown={this.onComponentMouseTouchDown}>
        {controlSelection}
        {children}
      </div>);
    };
