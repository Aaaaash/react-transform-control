...
var TransformControl = (function (_super) {
    ...
    function TransformControl() {
        ...
        _this.computedScaleRectBound = function (e) {
            ...
            var _a = _this.props, rectbound = _a.rectbound, maxWidth = _a.maxWidth;
            if (_this.xInversed) {
            ...
            // newWidth = newWidth > maxWidth - rectbound.x ? maxWidth - rectbound.x : newWidth;
            ...
            return __assign({}, rectbound, { x: newX <= 0 ? 0 : newX, y: newY <= 0 ? 0 : newY, w: newWidth, h: newHeight });
        };
